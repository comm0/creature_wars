...
![Screenshot placeholder: start screen with race selection](docs/images/readme-start-screen.png)

![Screenshot placeholder: battle between two races near a base](docs/images/readme-gameplay.png)
